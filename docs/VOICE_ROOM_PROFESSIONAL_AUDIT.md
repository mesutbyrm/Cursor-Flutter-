...
| Mention bildirimi (oda içi) | **ÇALIŞIYOR** (Faz 20) | RTC/Basic overlay; reconnect ile çakışma düzeltildi |
...
| Footer rebuild izolasyonu | **ÇALIŞIYOR** (Faz 14) | `VoiceRoomUiFooterSlice` + footer band |
| Side-effect selective listen | **ÇALIŞIYOR** (Faz 15) | Exit/moderation/müzik/mic gate dilimleri |
