...
**Tarih:** 2026-09-07 19:22 UTC  
**Oda slug:** `cmoohrbr`  
**Oda id (SSE):** `cmoohrbrx00a4nt08zlkdjyil`  
**Hesap:** `cursor.test.1786235468@mailinator.com` — jeton 97800→97800 (admin top-up)  
...
## POST song-request (id `cmoohrbrx00a4nt08zlkdjyil`, slug `cmoohrbr`) → HTTP 200
...
```json
{
    ...
    "nowPlaying": {
        ...
        "startedAt": "2026-09-07T19:22:24.793Z",
        "startedAtMs": 1788808944793,
        "elapsedSeconds": 0,
        "duration": "",
