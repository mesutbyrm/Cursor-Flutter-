...
|-----|-------|--------|
| FAZ1 | `test/core` | PASS |
| FAZ1 | `test/auth_service_test.dart` | PASS |
| FAZ1 | `test/api_response_test.dart` | PASS |
| FAZ1 | `test/core/network` | PASS |
| FAZ2 | `test/features/profile` | PASS |
| FAZ3 | `test/features/social` | PASS |
| FAZ4 | `test/features/fortune` | PASS |
