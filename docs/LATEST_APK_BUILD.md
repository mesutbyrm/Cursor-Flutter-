...
| İş akışı | [Run 27437185316](https://github.com/mesutbyrm/Cursor-Flutter-/actions/runs/27437185316) (Build #255) |
...
- **Kök neden:** Tek `MaterialApp` ile `initialLocation: /feed` → shell önce yükleniyor, `/login` redirect'i yetim `ModalBarrier` bırakıyordu
