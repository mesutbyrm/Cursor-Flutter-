...
echo "╚══════════════════════════════════════════════════════════════════╝"
echo ""
echo "Agent tarafı: TAMAM (kod, CI release gate, dokümantasyon)"
echo "Sizin tarafınız: Psychic P0 — önce jeton, sonra 2 telefon (T+5s donma yok)"
echo ""
echo "── Kalan işler (P0-j → P0 → P1 → P2) ──"
echo "  bash scripts/release-remaining-status.sh"
echo ""
echo "── 1. Jeton (jeton=0 ise seans başlamaz) ──"
echo "  bash scripts/admin-jeton-cheatsheet.sh"
echo "  bash scripts/psychic-p0-prereqs.sh"
echo "  Hızlı rehber: docs/PSYCHIC_P0_START.md"
echo ""
echo "── APK ──"
echo "  ${APK_URL}"
echo ""
