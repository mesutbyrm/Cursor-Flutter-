...
echo ""
echo "── Admin secret'ları (manuel) ──"
echo "Jeton top-up (M5/M7) için repo admin hesabıyla ekleyin:"
echo "  gh secret set ACCEPTANCE_ADMIN_EMAIL --repo $REPO"
echo "  gh secret set ACCEPTANCE_ADMIN_PASSWORD --repo $REPO"
echo "  # veya ACCEPTANCE_ADMIN_USERNAME + şifre"
echo ""
echo "Detay: docs/M5_M7_JETON_BLOCKER.md"
echo ""
echo "Tamamlandı. Doğrulama:"
echo "  bash scripts/validate-acceptance-secrets.sh"
