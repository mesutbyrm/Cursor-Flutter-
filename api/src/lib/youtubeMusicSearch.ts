 ...
 * Anahtar yalnızca sunucuda: process.env.YOUTUBE_API_KEY
 */
...
/**
 * YouTube Data API v3 ile arama. YOUTUBE_API_KEY yoksa hata fırlatır.
 */
...
/** chatRoomStore / eski uçlar için geriye dönük map */
export function toLegacyYoutubeHits(items: MusicSearchItem[]) {
