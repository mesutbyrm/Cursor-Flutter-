...
### v1.0.5 (sürüm etiketi)

**[canlifal-mobile-release.apk (v1.0.5)](https://github.com/mesutbyrm/Cursor-Flutter-/releases/download/v1.0.5/canlifal-mobile-release.apk)**

Sürüm sayfası (Assets): [v1.0.5](https://github.com/mesutbyrm/Cursor-Flutter-/releases/tag/v1.0.5). Bağlantı, `v1.0.5` etiketi oluşturulup [Build release APK](https://github.com/mesutbyrm/Cursor-Flutter-/actions/workflows/build-apk.yml) iş akışı bu etiket üzerinde **başarıyla tamamlandıktan** sonra 404 olmaz. Kod içi sabit: `AppLinks.androidReleaseApkV105`.
...
## Sürüm etiketi (ör. v1.0.5)

```bash
git tag -a v1.0.5 -m "Canlifal mobile v1.0.5" && git push origin v1.0.5
```
