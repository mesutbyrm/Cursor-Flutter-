...
/// Premium canlı yayın ana sayfa (dummy veri + animasyonlar).
              ...
              SliverPadding(
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                    PremiumHomeHeader(displayName: PremiumHomeDummyData.userName),
                    SizedBox(height: PremiumHomeLayout.sectionGap.h * 0.5),
                    HeroLiveCarousel(streams: PremiumHomeDummyData.heroStreams),
                    ...
                    QuickActionsSection(actions: PremiumHomeDummyData.quickActions),
                    SizedBox(height: PremiumHomeLayout.sectionGap.h),
                    SectionTitleRow(
                    ...
                    SizedBox(height: 1.4.h),
                    VoiceSpheresSection(rooms: PremiumHomeDummyData.voiceRooms),
                    SizedBox(height: PremiumHomeLayout.sectionGap.h),
                    SectionTitleRow(
                      title: 'Fal & Tarot',
