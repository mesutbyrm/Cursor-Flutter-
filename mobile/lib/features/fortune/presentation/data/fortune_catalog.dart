...
abstract final class FortuneCatalog {
  ...
  static const types = <FortuneTypeEntity>[
    ...
    FortuneTypeEntity(
      ...
      slug: 'istihare',
      title: 'İstihare',
      description: 'Kalbini dinle, rehberlik al',
      emoji: '🕌',
      accent: Color(0xFF14B8A6),
      kind: FortuneSessionKind.pendulum,
      ctaLabel: 'Falını Aç',
    ...
    FortuneTypeEntity(
      ...
      slug: 'kursundokme',
      title: 'Kurşun Dökme',
      description: 'Geleneksel kurşun dökme ile enerji temizliği',
      emoji: '🕯️',
    ...
    FortuneTypeEntity(
      ...
      description: 'Astrolojik doğum haritan ve gezegen etkileri',
      emoji: '🪐',
      accent: Color(0xFF6366F1),
      kind: FortuneSessionKind.zodiacWheel,
      ctaLabel: 'Falını Aç',
