...
mixin _$PostDto {
 ...
 String get id; UserEntity get author; String? get caption; String? get mediaUrl; int get likesCount; int get commentsCount; DateTime? get createdAt; String? get fortuneType; int get viewCount; int get viewsCount; bool get isLiked; bool get isAutoShare; int get fortuneCount; String? get postType; bool get likedByMe;
...
@override
int get hashCode => Object.hash(runtimeType,id,author,caption,mediaUrl,likesCount,commentsCount,createdAt,fortuneType,viewCount,viewsCount,isLiked,isAutoShare,fortuneCount,postType,likedByMe);

@override
String toString() {
  return 'PostDto(id: $id, author: $author, caption: $caption, mediaUrl: $mediaUrl, likesCount: $likesCount, commentsCount: $commentsCount, createdAt: $createdAt, fortuneType: $fortuneType, viewCount: $viewCount, viewsCount: $viewsCount, isLiked: $isLiked, isAutoShare: $isAutoShare, fortuneCount: $fortuneCount, postType: $postType, likedByMe: $likedByMe)';
}
...
@useResult
$Res call({
 String id, UserEntity author, String? caption, String? mediaUrl, int likesCount, int commentsCount, DateTime? createdAt, String? fortuneType, int viewCount, int viewsCount, bool isLiked, bool isAutoShare, int fortuneCount, String? postType, bool likedByMe
});
...
/// Create a copy of PostDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? author = null,Object? caption = freezed,Object? mediaUrl = freezed,Object? likesCount = null,Object? commentsCount = null,Object? createdAt = freezed,Object? fortuneType = freezed,Object? viewCount = null,Object? viewsCount = null,Object? isLiked = null,Object? isAutoShare = null,Object? fortuneCount = null,Object? postType = freezed,Object? likedByMe = null,}) {
...
as bool,isAutoShare: null == isAutoShare ? _self.isAutoShare : isAutoShare // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  UserEntity author,  String? caption,  String? mediaUrl,  int likesCount,  int commentsCount,  DateTime? createdAt,  String? fortuneType,  int viewCount,  int viewsCount,  bool isLiked,  bool isAutoShare,  int fortuneCount,  String? postType,  bool likedByMe)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PostDto() when $default != null:
return $default(_that.id,_that.author,_that.caption,_that.mediaUrl,_that.likesCount,_that.commentsCount,_that.createdAt,_that.fortuneType,_that.viewCount,_that.viewsCount,_that.isLiked,_that.isAutoShare,_that.fortuneCount,_that.postType,_that.likedByMe);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  UserEntity author,  String? caption,  String? mediaUrl,  int likesCount,  int commentsCount,  DateTime? createdAt,  String? fortuneType,  int viewCount,  int viewsCount,  bool isLiked,  bool isAutoShare,  int fortuneCount,  String? postType,  bool likedByMe)  $default,) {final _that = this;
switch (_that) {
case _PostDto():
return $default(_that.id,_that.author,_that.caption,_that.mediaUrl,_that.likesCount,_that.commentsCount,_that.createdAt,_that.fortuneType,_that.viewCount,_that.viewsCount,_that.isLiked,_that.isAutoShare,_that.fortuneCount,_that.postType,_that.likedByMe);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  UserEntity author,  String? caption,  String? mediaUrl,  int likesCount,  int commentsCount,  DateTime? createdAt,  String? fortuneType,  int viewCount,  int viewsCount,  bool isLiked,  bool isAutoShare,  int fortuneCount,  String? postType,  bool likedByMe)?  $default,) {final _that = this;
switch (_that) {
case _PostDto() when $default != null:
return $default(_that.id,_that.author,_that.caption,_that.mediaUrl,_that.likesCount,_that.commentsCount,_that.createdAt,_that.fortuneType,_that.viewCount,_that.viewsCount,_that.isLiked,_that.isAutoShare,_that.fortuneCount,_that.postType,_that.likedByMe);case _:
  return null;
...
class _PostDto extends PostDto {
  const _PostDto({required this.id, required this.author, this.caption, this.mediaUrl, this.likesCount = 0, this.commentsCount = 0, this.createdAt, this.fortuneType, this.viewCount = 0, this.viewsCount = 0, this.isLiked = false, this.isAutoShare = false, this.fortuneCount = 0, this.postType, this.likedByMe = false}): super._();
...
/// Create a copy of PostDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? author = null,Object? caption = freezed,Object? mediaUrl = freezed,Object? likesCount = null,Object? commentsCount = null,Object? createdAt = freezed,Object? fortuneType = freezed,Object? viewCount = null,Object? viewsCount = null,Object? isLiked = null,Object? isAutoShare = null,Object? fortuneCount = null,Object? postType = freezed,Object? likedByMe = null,}) {
