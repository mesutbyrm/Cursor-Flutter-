...
class DiscoverHeader extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final coins = user?.coinBalance ?? 12540;
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: AppDesign.glowShadow(AppDesign.accentPurple, blur: 16),
            ),
...
class _CoinCapsule extends StatelessWidget {
  const _CoinCapsule({required this.label});
