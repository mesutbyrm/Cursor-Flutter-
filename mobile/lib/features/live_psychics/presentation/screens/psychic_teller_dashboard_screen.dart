        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/packages'),
                icon: const Icon(Icons.card_giftcard_outlined, size: 18),
                label: const Text('Paketler'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/customers'),
        ...
        Row(
          children: [
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/badges'),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/ratings'),
                icon: const Icon(Icons.star_rate_rounded, size: 18),
                label: const Text('Puanlamalarım'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/gamification'),
                icon: const Icon(Icons.emoji_events_outlined, size: 18),
                label: const Text('Gamifikasyon'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/customer-chemistry'),
                icon: const Icon(Icons.psychology_rounded, size: 18),
                label: const Text('Müşteri Kimyası'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/message-templates'),
                icon: const Icon(Icons.mail_outline_rounded, size: 18),
                label: const Text('Mesaj Şablonları'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/advanced-search'),
                icon: const Icon(Icons.manage_search_rounded, size: 18),
                label: const Text('Gelişmiş Arama'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/analytics-export'),
                icon: const Icon(Icons.download_rounded, size: 18),
                label: const Text('Analitik İhraç'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/retention-analytics'),
                icon: const Icon(Icons.trending_up_rounded, size: 18),
                label: const Text('Müşteri Bekletimi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/performance-insights'),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/revenue-forecasting'),
                icon: const Icon(Icons.trending_up_rounded, size: 18),
                label: const Text('Gelir Tahminlemesi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/campaign-management'),
                icon: const Icon(Icons.email_rounded, size: 18),
                label: const Text('Kampanya Yönetimi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/social-media-planner'),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/ai-chatbot'),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/withdrawal-management'),
                icon: const Icon(Icons.account_balance_wallet_rounded, size: 18),
                label: const Text('Çekim Yönetimi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/feedback-management'),
                icon: const Icon(Icons.rate_review_rounded, size: 18),
                label: const Text('Geri Bildirim Yönetimi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/churn-analysis'),
                icon: const Icon(Icons.trending_down_rounded, size: 18),
                label: const Text('Kayıp Analizi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/scheduling-optimization'),
                icon: const Icon(Icons.schedule_rounded, size: 18),
                label: const Text('Planlama Optimizasyonu'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/tax-reporting'),
                icon: const Icon(Icons.receipt_rounded, size: 18),
                label: const Text('Vergi Raporları'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/session-recording'),
                icon: const Icon(Icons.videocam_rounded, size: 18),
                label: const Text('Seans Kayıtları'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/benchmarking'),
                icon: const Icon(Icons.leaderboard_rounded, size: 18),
                label: const Text('Performans Karşılaştırması'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/behavior-analytics'),
                icon: const Icon(Icons.analytics_rounded, size: 18),
                label: const Text('Davranış Analizi'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
        ...
        Row(
          children: [
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/workflow-automation'),
                icon: const Icon(Icons.automation_rounded, size: 18),
                label: const Text('İş Akışı Otomasyonu'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
            ...
            Expanded(
              child: OutlinedButton.icon(
                onPressed: () =>
                    context.push('/canli-falcilar/compliance-legal'),
                icon: const Icon(Icons.verified_user_rounded, size: 18),
                label: const Text('Uyum & Hukuki'),
                style: OutlinedButton.styleFrom(
                  foregroundColor: Colors.white,
                  side: BorderSide(color: Colors.white.withValues(alpha: 0.2)),
                ),
