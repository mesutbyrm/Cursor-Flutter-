...
import 'package:api_example/pages/advance_media/pcm_record_playback/pcm_record_playback_prepare_page.dart';
...
List<RouterInfo> advanceAvList = [
  ...
  RouterInfo(
    ...
    title: 'PCM Record & Playback',
    page: const PcmRecordPlaybackPreparePage(),
  ),
  RouterInfo(
